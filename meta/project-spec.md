...
- Tool directory:
  - `opencode` => `.opencode/`
  - `claude` => `.claude/`
- Context name normalization: When deriving a context directory name from a ticket key, the implementation MUST convert the ticket key to lowercase. Example: `xyz-1234` becomes `xyz-1234`.
